...
<html lang="en">
    <!--
        ...
        Utilidad: Este programa consiste en mostrar en tu página index la fecha y hora actual formateada en castellano.
    ...
    <body>
        ...
        <?php
            ...
            echo "1º opcion(format)<br>";
            //Creación de un objeto Datetime().
            $ofechaActual = new DateTime();
            //Salida formateada con el método format().
            echo $ofechaActual->format('d F o H:i:s');
            echo "<br>2º opcion(strftime)<br>";
            //Salida formateada con el método strftime().
            echo strftime("%d de %B de %Y %H:%M:%S");
        ?>
