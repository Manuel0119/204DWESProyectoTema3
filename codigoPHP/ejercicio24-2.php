                ...
                <form name="ejercicio24" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                    <table class="formulario">
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="apellidos" class="entradadatos" value="<?php echo $_REQUEST['apellidos'] ?? ''; ?>"/></td><!-- Apellidos del usuario. -->
                            <!--Mostrar los errores.-->
                            <td><?php echo '<span style="color: red;">' . $aErrores["Apellidos"] . '</span>' . "<br><br>"; ?></td>
                        </tr>
                        <tr>
                            <td><label for="altura">Altura(cm):</label></td>
                            <td><input type="text" name="altura" class="entradadatos" value="<?php echo $_REQUEST['altura'] ?? ''; ?>"/></td><!-- Altura del usuario. -->
                            <!--Mostrar los errores.-->
                            <td><?php echo '<span style="color: red;">' . $aErrores["Altura"] . '</span>' . "<br><br>"; ?></td>
                        </tr>  
                        <tr>
                            <td><label for="email">*Email:</label></td>
                            <td><input type="email" name="email" class="entradadatos" value="<?php echo $_REQUEST['email'] ?? ''; ?>"/></td><!-- Email del usuario. -->
                            <!--Mostrar los errores.-->
                            <td><?php echo '<span style="color: red;">' . $aErrores["Email"] . '</span>' . "<br><br>"; ?></td>
                        </tr>
                        <tr>
                            <td><label for="contrasena">*Contraseña:</label></td>
                            <td><input type="password" name="contrasena" class="entradadatos" value="<?php echo $_REQUEST['contrasena'] ?? ''; ?>"/></td><!-- Contraseña del usuario. -->
                            <!--Mostrar los errores.-->
                            <td><?php echo '<span style="color: red;">' . $aErrores["Contrasena"] . '</span>' . "<br><br>"; ?></td>
                        </tr>
                        <tr>
                            <td><label for="tel">Tel.:</label></td>
                            <td><input type="tel" name="tel" class="entradadatos" value="<?php echo $_REQUEST['tel'] ?? ''; ?>"/></td><!-- Teléfono del usuario. -->
                            <!--Mostrar los errores.-->
                            <td><?php echo '<span style="color: red;">' . $aErrores["Tel"] . '</span>' . "<br><br>"; ?></td>
                        </tr>
                        <tr>
                            <td><label for="cp">CP[Código Postal]:</label></td>
                            <td><input type="number" name="cp" class="entradadatos" value="<?php echo $_REQUEST['cp'] ?? ''; ?>"/></td><!-- Codigo Postal. -->
                            <!--Mostrar los errores.-->
                            <td><?php echo '<span style="color: red;">' . $aErrores["CP"] . '</span>' . "<br><br>"; ?></td>
                        </tr>
                        <tr>
                            <td><label for="fechaNacimiento">*Fecha de Nacimiento[aaaa-mm-dd]:</label></td>
                            <td><input type="datetime" name="fechaNacimiento" class="entradadatos" value="<?php echo $_REQUEST['fechaNacimiento'] ?? ''; ?>"/></td><!-- Fecha de nacimiento del usuario. -->
                            <!--Mostrar los errores.-->
                            <td><?php echo '<span style="color: red;">' . $aErrores["FechaNacimiento"] . '</span>' . "<br><br>"; ?></td>
                        </tr>
                        <tr>
                            <td><label for="pais">País:</label></td>
                            <td><input type="text" name="pais" value="España" disabled></td>
                        </tr>
                        <tr>
