...
<html lang="en">
    <!--
        ...
        Utilidad: Este programa consiste en mostrar el path donde se encuentra el fichero que se está ejecutando.
    ...
    <body>
        <div class="encabezado">
            <h2>9. Mostrar el path donde se encuentra el fichero que se está ejecutando.</h2>
        </div>       
        <?php
