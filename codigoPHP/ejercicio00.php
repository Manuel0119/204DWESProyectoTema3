...
<html lang="en">
    <!--
        ...
        Utilidad: Este programa consiste en sacar por pantalla un hola mundo y mostrar el resultado de la funcion phpinfo().
    ...
    <body>
        <div class="encabezado">
            <h2>0. Hola mundo y phpinfo()</h2>
        </div>
        <?php
        //Con echo imprimiremos un hola mundo y ademas, sacararemos el resultado de la función phpinfo().
        echo "Hola Mundo";
        phpinfo();
        ?>
