...
<html lang="en">
    <!--
        ...
        Utilidad: Este programa consiste en inicializar y mostrar una variable heredoc.
    ...
    <body>
        <div class="encabezado">
            <h2>2. Inicializar y mostrar una variable heredoc.</h2>
        </div>     
        <?php
            //Variable tipo heredoc.
            $str =<<<"EOD"
            Este es un ejemplo de uso de
            una variable heredoc de php
            EOD;
            echo $str;
        ?>
