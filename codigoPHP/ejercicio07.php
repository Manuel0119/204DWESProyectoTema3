...
<html lang="en">
    <!--
        ...
        Utilidad: Este programa consiste en mostrar el nombre del fichero que se está ejecutando.
    ...
    <body>
        <div class="encabezado">
            <h2>7. Mostrar el nombre del fichero que se está ejecutando.</h2>
        </div>
        <?php
            //Imprimimos por pantalla la ruta completa del fichero actual.
            echo "<br>Ruta completa<br>";
            echo $_SERVER['PHP_SELF'];
            //Imprimimos por pantalla el nombre del fichero actual mediante el método basename().
            echo "<br>Ruta con solo el nombre del fichero<br>";
